...
/**
 * Represents a core-related API module that can be dynamically loaded into the MCEngine.
 * <p>
...
public interface IMCEngineCoreAPI {
     ...
     *
     * @param plugin The {@link Plugin} instance that is providing the context for this API module.
     */
